...
| MATLAB | New Astra Max, actual turn metadata verified | MIGRATED; full receipt/hash and understanding accepted; original Ultra archived | Published product commit 34e2cf1, pinned to shared 922d950 | Startup fix, Alpha.4 P1 package and isolated P2 primitives reviewed. P1 staged once with 4,058 files verified; finite external Apply reviewed. Alpha.3 remains active, normal host release is pending, and exact public-branch permission remains a platform approval blocker |
| Mnova | New Astra Max, actual turn metadata verified | MIGRATED; full receipt/hash and understanding accepted; original Ultra archived | Adopted in isolated candidate 1f24531 | dev2 public prerelease and official installed plugin verified at e22718c; nine raw modules and 65 source/cache files match. Current task still reports dev1 through its old connection; normal host pickup remains open. Original product/Hub work preserved; native writes and close disabled |
| ChemDraw | Local Astra Max intake active; source architecture Astra Ultra; remote source model unresolved | MAX_VERIFYING; understanding accepted; historical native materials incomplete | Local adoption included in reviewed repair plan | Local CD-LC-01 through 04 source repair design accepted; native execution freeze remains. A new Companion package does not yet exist; the separately installed legacy ChemAIst plugin is not installation evidence for this product |
