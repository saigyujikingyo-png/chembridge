...
| Mnova | New Astra Max, actual turn metadata verified | MIGRATED; full receipt/hash and understanding accepted; original Ultra archived | Adopted in isolated candidate 1f24531 | dev2 candidate e22718c reviewed; nine modules match raw Git, wheel and separately installed runtime; official plugin switch/publication still pending. Original 18 product + 8 Hub files preserved; native writes and close remain disabled |
