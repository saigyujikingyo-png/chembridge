...
Governance's preliminary review of the in-progress UoE fix requested focused regressions for children born during cleanup and multiple logical MCP child chains under one daemon. Final source acceptance waits for an exact candidate and its evidence. The restored 0.8.1 transport has not been relabelled as that future fix.
