...
principles = (root / "DEVELOPMENT_PRINCIPLES.md").read_text(encoding="utf-8")
assert f"Rule version: **{catalog['shared_rule_version']}**" in principles, "Shared rule version mismatch"
links = 0
